...
export default function LoginPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Giriş başarılıysa token varsa burada yakala:
      // localStorage.setItem("token", data.token);

      // Eğer login context kullanıyorsan, burada çağır:
      login(data); // örneğin kullanıcı bilgilerini context'e kaydedebilirsin

      navigate("/home");
    } catch (err) {
      // Giriş başarısızsa
      setError("Giriş başarısız. Lütfen e-posta ve şifrenizi kontrol ediniz.");
    }
  };
